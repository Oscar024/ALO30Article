...
tn= normaliza(t,1);
if(sol(1)==1)%  1 capa
  net=newff(minmax(pn),[sol(2),1],{'tansig','purelin','logsig'},'trainlm');                
else    % 2 capas
  net=newff(minmax(pn),[sol(2),sol(3),1],{'tansig','tansig','purelin','purelin','logsig'},'trainlm');  
end
